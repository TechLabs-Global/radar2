...
<div class="flex flex-row max-w-60">
	{#if !phase}
		{#if firstInWeek}
			<div
				class="flex items-center justify-center border-solid border border-gray-200 rounded-md bg-gray-100 text-gray-600 shadow-md min-w-11 max-w-11 min-h-11 max-h-11 text-center font-bold text-sm font-mono"
			>
				W{week}
			</div>
		{:else}
		...
		{#if !emptyWeek}
			...
			<div class="flex flex-col pl-2">
				<div class="font-bold text-sm" class:line-through={passed} class:text-gray-600={passed}>

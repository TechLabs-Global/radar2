...
Our goal is for everybody to have a clear understanding about TechLabs Dortmund and your Journey!', 'event', FALSE, TRUE, 1) ON CONFLICT (id) DO NOTHING;
...
You will also get the chance to brainstorm for possible project ideas.', 'event', FALSE, TRUE, 1) ON CONFLICT (id) DO NOTHING;
...
The event will be held online as it is way easier to share screens', 'event', FALSE, FALSE, 1) ON CONFLICT (id) DO NOTHING;
...
You only need to join this event if you haven''t joined the in-person version of the Ideation Workshop.', 'event', FALSE, FALSE, 1) ON CONFLICT (id) DO NOTHING;
...
Of course this will be guided by TechLabs Dortmund team members and Design Thinking Experts!', 'event', FALSE, TRUE, 1) ON CONFLICT (id) DO NOTHING;
...
The workshop is a hands-on training session that introduces you to Agile development methodologies, promoting collaboration and adaptability in a concise and interactive format.', 'event', FALSE, TRUE, 1) ON CONFLICT (id) DO NOTHING;
...
The goal is to help you get a better overview of other projects, get some inspiration and guidance and to help each other out with potential issues.', 'event', FALSE, TRUE, 1) ON CONFLICT (id) DO NOTHING;
...
We will also have a little closing ceremony, announce a winner and inform you about the next steps to receive your Digital Shaper Certificate!', 'event', FALSE, TRUE, 1) ON CONFLICT (id) DO NOTHING;

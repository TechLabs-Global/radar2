...
VALUES (
        '46d931c2-6fab-4fde-a3ad-93ea775887cd',
        'KoFabrik in Bochum',
        'Stühmeyerstraße 33, 44787 Bochum',
        'https://maps.app.goo.gl/e3wjUvQmCFNY3GT47',
        'offline'
    ), (
        'dfd9a004-562e-427e-a95a-154edecf762f',
...
VALUES ('713b7b69-b2fc-4f5d-9164-bfdffe430fc7', 'Test Event 1', current_timestamp + interval '3 days', 'This is a in-person test event', 'event', FALSE, FALSE, '46d931c2-6fab-4fde-a3ad-93ea775887cd'), ('94d2b1b9-fd59-4a14-99d5-1cc5cde9d070', 'Test Event 2', current_timestamp + interval '5 days', 'This is a online test event', 'event', FALSE, FALSE, 'dfd9a004-562e-427e-a95a-154edecf762f') ON CONFLICT (id) DO NOTHING;
...
Our goal is for everybody to have a clear understanding about TechLabs Dortmund and your Journey!', 'event', FALSE, TRUE, '46d931c2-6fab-4fde-a3ad-93ea775887cd') ON CONFLICT (id) DO NOTHING;


INSERT INTO events (id, title, event_date, description, type, is_public, is_mandatory, location_id)
VALUES ('0bcab313-78ee-4962-bd90-726172445f91', '50% Checkpoint', '2024-06-04 19:00:00 +02:00', 'You should aim to have completed around __50%__ of your learning material by this date. This is __not__ a cutting point, only a general recommendation to help you pace your studies.', 'checkpoint', TRUE, FALSE, NULL) ON CONFLICT (id) DO NOTHING;


INSERT INTO events (id, title, event_date, description, type, is_public, is_mandatory, location_id)
VALUES ('5ecb9a56-9e68-43b2-82a5-975bef243008', 'Open Track Q&A', '2024-12-20 19:00:00 +02:00', 'Are you lost or do you have questions regarding your track? We''ve got you covered! Join us for an open Q&A session where you can ask all your questions and get help from our mentors.', 'event', FALSE, FALSE, '46d931c2-6fab-4fde-a3ad-93ea775887cd') ON CONFLICT (id) DO NOTHING;
...
We are looking forward to you getting to know each other a little bit more and having a fun time together.', 'event', FALSE, FALSE, '46d931c2-6fab-4fde-a3ad-93ea775887cd') ON CONFLICT (id) DO NOTHING;
...
__DL__ - min. 40h
__UX__ - min. 40h
__WD__ - min. 30h', 'cutoff', TRUE, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
...
You will also get the chance to brainstorm for possible project ideas.', 'event', FALSE, TRUE, '46d931c2-6fab-4fde-a3ad-93ea775887cd') ON CONFLICT (id) DO NOTHING;
...
The event will be held online as it is way easier to share screens', 'event', FALSE, FALSE, '46d931c2-6fab-4fde-a3ad-93ea775887cd') ON CONFLICT (id) DO NOTHING;
...
You only need to join this event if you haven''t joined the in-person version of the Ideation Workshop.', 'event', FALSE, FALSE, '46d931c2-6fab-4fde-a3ad-93ea775887cd') ON CONFLICT (id) DO NOTHING;
...
Of course this will be guided by TechLabs Dortmund team members and Design Thinking Experts!', 'event', FALSE, TRUE, '46d931c2-6fab-4fde-a3ad-93ea775887cd') ON CONFLICT (id) DO NOTHING;
...
To do so, please set up a meeting with your Journey Project Manager and provide him/her with a short summary of what you''ve been doing.', 'checkpoint', TRUE, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
...
The workshop is a hands-on training session that introduces you to Agile development methodologies, promoting collaboration and adaptability in a concise and interactive format.', 'event', FALSE, TRUE, '46d931c2-6fab-4fde-a3ad-93ea775887cd') ON CONFLICT (id) DO NOTHING;
...
The goal is to help you get a better overview of other projects, get some inspiration and guidance and to help each other out with potential issues.', 'event', FALSE, TRUE, '46d931c2-6fab-4fde-a3ad-93ea775887cd') ON CONFLICT (id) DO NOTHING;
...
The Project Submission Form must be submitted **once per project team**.', 'cutoff', TRUE, FALSE, NULL) ON CONFLICT (id) DO NOTHING;


INSERT INTO events (id, title, event_date, description, type, is_public, is_mandatory, location_id)
VALUES ('2174e552-da5d-4359-ad5e-731505526262', 'Data Science & Backend', '2024-08-08 19:00:00 +02:00', 'We will give you an introduction on how to connect your Data Science insights to your backend as well as connecting your backend to your frontend. Learn the basics of FastAPI in Python.', 'event', FALSE, FALSE, '46d931c2-6fab-4fde-a3ad-93ea775887cd') ON CONFLICT (id) DO NOTHING;
...
We will also have a little closing ceremony, announce a winner and inform you about the next steps to receive your Digital Shaper Certificate!', 'event', FALSE, TRUE, '46d931c2-6fab-4fde-a3ad-93ea775887cd') ON CONFLICT (id) DO NOTHING;


-- PHASES

INSERT INTO phases (title, description, date_from, date_to)
VALUES ('Onboarding Phase', 'You join the community and get access to our learning platform edyoucated. We present our four tracks, you choose one and create your personal TechLabs journey based on your previous knowledge.', '2024-04-27 00:00:00 +02:00', '2024-04-28 00:00:00 +02:00') ON CONFLICT (id) DO NOTHING;


INSERT INTO phases (title, description, date_from, date_to)
VALUES ('Academy Phase', 'You work through your track on edyoucated and become a master of your class. We organize social events regularly so that you can connect with fellow Techies, share your insights and work together on difficulties.', '2024-04-29 00:00:00 +02:00', '2024-07-19 00:00:00 +02:00') ON CONFLICT (id) DO NOTHING;


INSERT INTO phases (title, description, date_from, date_to)
VALUES ('Project Phase', 'This is prime time! You imagine and implement a prototype in a project of your own. You team up as a group of about 5 Techies and work together to create something big. Experienced mentors will be on your side for support.', '2024-07-20 00:00:00 +02:00', '2024-10-13 00:00:00 +02:00') ON CONFLICT (id) DO NOTHING;


INSERT INTO phases (title, description, date_from, date_to)
VALUES ('Closing Week', 'You finish up your prototype and submit the final result to us. We organize a closing ceremony where you will pitch your final results.', '2024-10-14 00:00:00 +02:00', '2024-10-18 00:00:00 +02:00') ON CONFLICT (id) DO NOTHING;
...
INSERT INTO config VALUES ('term.firstWeek', '0') ON CONFLICT (key) DO NOTHING;
